# Graph Report - A2A-SIN-Worker-heypiggy (2026-05-02)

## Corpus Check

- 152 files · ~177,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 2632 nodes · 7524 edges · 98 communities detected
...
Cohesion: 0.15
Nodes (13): active(), from*dict(), from_json_file(), load_active_profile(), PlatformProfile, Kompiliert die Reward-Regex einmalig., # WHY: Wir liefern HeyPiggy als Default und ein paar Community-bekannte, Ermittelt das aktive Profil in dieser Prioritaet: 1) ENV PLATFORM_PROFILE* (+5 more)
...
Cohesion: 1.0
Nodes (1): Wartet auf URL-/DOM-Veränderung statt fixer Sleeps.

### Community 111 - "Community 111"

Cohesion: 1.0
Nodes (1): Bewerte einen potentiellen Survey-Entry nach Text/Href-Signalen.

### Community 112 - "Community 112"

Cohesion: 1.0
Nodes (1): Bewerte einen echten Survey-Start-Kandidaten auf der Quellenliste.

### Community 113 - "Community 113"

Cohesion: 1.0
Nodes (1): Erkennt die typischen Consent-/Another-survey-open-Screens. Diese Screens ö

### Community 114 - "Community 114"

Cohesion: 1.0
Nodes (1): Bearbeitet die häufigsten Survey-Consent-Screens automatisch.

### Community 115 - "Community 115"

Cohesion: 1.0
Nodes (1): Wählt den aktivsten Tab aus einem Multi-Tab-Survey-Flow.

### Community 116 - "Community 116"

Cohesion: 1.0
Nodes (1): Legacy loop. Fails closed unless explicitly enabled for non-live tests.

## Knowledge Gaps

- **422 isolated node(s):** `Liefert (input_eur, output_eur) per MTok fuer ein Modell.`, `Laufende Zaehler fuer einen Run.`, `Verwaltet Limits und Counter fuer einen Worker-Run.      Usage:         guard =`, `Liest Limits aus ENV:           BUDGET_MAX_TOKENS     (default 0 = unbegrenzt)`, `Registriert Token-Verbrauch und prueft Limits sofort.` (+417 more)
...
- **Thin community `Community 108`** (1 nodes): `Run one prompt and return a structured result.          ``images`` are URLs or d`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `Wartet auf URL-/DOM-Veränderung statt fixer Sleeps.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `Bewerte einen potentiellen Survey-Entry nach Text/Href-Signalen.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `Bewerte einen echten Survey-Start-Kandidaten auf der Quellenliste.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `Erkennt die typischen Consent-/Another-survey-open-Screens.      Diese Screens ö`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `Bearbeitet die häufigsten Survey-Consent-Screens automatisch.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `Wählt den aktivsten Tab aus einem Multi-Tab-Survey-Flow.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `Legacy loop. Fails closed unless explicitly enabled for non-live tests.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
